...
#define CONFIGURE_ARGS "--enable-thread-safety --with-ldap --with-openssl --with-libxml --with-libxslt --with-gssapi"
...
#define PG_VERSION_STR "PostgreSQL 13.8, compiled by Visual C++ build " CppAsString2(_MSC_VER) ", 64-bit"
