...
hh = pd.read_csv(os.path.join(outputDir, 'household_'+MODEL_YEAR+'_HH.dat'), sep = ' ')
hhper = pd.read_csv(os.path.join(outputDir,'person_'+MODEL_YEAR+'_HH.dat'), sep = ' ')

#gq

gq = pd.read_csv(os.path.join(outputDir, 'household_'+MODEL_YEAR+'_GQ.dat'), sep = ' ')
...
gqper = pd.read_csv(os.path.join(outputDir, 'person_'+MODEL_YEAR+'_GQ.dat'), sep = ' ')
...
finalhh.to_csv(os.path.join(outputDir, 'household_'+MODEL_YEAR+'.dat'), sep = ' ', index = False)

finalper = pd.concat([hhper,gqper], ignore_index=True)
finalper.to_csv(os.path.join(outputDir, 'person_'+MODEL_YEAR+'.dat'), sep = ' ', index = False)
