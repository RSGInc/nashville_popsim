...
import os
directory = 'E:\Projects\Clients\Nashville\Tasks\Task2_PopSim\Data'
taz = gpd.read_file(r'E:\Projects\Clients\Nashville\Data\Other\TAZ\GIS\TAZ_nashville_project.shp')
...
bg = gpd.read_file(os.path.join(directory,'BlockGroup','tl_2018_47_bg.shp'))
...
tract = gpd.read_file(os.path.join(directory,'CensusTract','tl_2018_47_tract.shp'))
...
county = gpd.read_file(os.path.join(directory,'County','tl_2018_us_county.shp'))
...
puma = gpd.read_file(os.path.join(directory,'PUMS','Geography','tl_2018_47_puma10.shp'))
