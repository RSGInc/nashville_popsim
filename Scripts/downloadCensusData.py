...
if not os.path.isfile(os.path.join(censusDownloadDir, 'hhsize_BG_2021_acs5.csv')):	
	...
	for i,cen in enumerate(COUNTY_FIPS_STRING):	
		if i == 0:
			...
			hhsize_BG = pd.concat([hhsize_BG, getCensusData(name = "acs/acs5", 	
									 ...
									 region = "block%20group:*",	
									 regionin = "state:{}%20county:{}".format(STATE_FIPS, cen))])
	hhsize_BG.to_csv(os.path.join(censusDownloadDir, "hhsize_BG_2021_acs5.csv"), index = False)

if not os.path.isfile(os.path.join(censusDownloadDir, 'hhtype_BG_2021_acs5.csv')):	
	...
	hhtype_BG.to_csv(os.path.join(censusDownloadDir, 'hhtype_BG_2021_acs5.csv'), index = False)

#B26103_001E,B26103_006E,B26103_007E - total gqs, total non-inst gqs, college/univ gqs
if not os.path.isfile(os.path.join(censusDownloadDir, 'gqtot_CT_2021_acs5.csv')):
	gqs_BG = pd.DataFrame()
	for i,cen in enumerate(COUNTY_FIPS_STRING):	
		if i == 0:
	...
	gqs_BG.to_csv(os.path.join(censusDownloadDir, 'gqtot_CT_2021_acs5.csv'), index = False)
...
if not os.path.isfile(os.path.join(censusDownloadDir, 'hhtenure_BG_2021_acs5.csv')):
	...
	hhtenure_BG.to_csv(os.path.join(censusDownloadDir, 'hhtenure_BG_2021_acs5.csv'), index = False)
	
	
if not os.path.isfile(os.path.join(censusDownloadDir, 'hhworker_CT_2021_acs5.csv')):
	...
	hhworker_CT.to_csv(os.path.join(censusDownloadDir, 'hhworker_CT_2021_acs5.csv'), index = False)

if not os.path.isfile(os.path.join(censusDownloadDir, 'hhincome_CT_2021_acs5.csv')):
	...
	hhincome_CT.to_csv(os.path.join(censusDownloadDir, 'hhincome_CT_2021_acs5.csv'), index = False)

if not os.path.isfile(os.path.join(censusDownloadDir, 'populationbyageandsex_CT_2021_acs5.csv')):
	...
	popage_CT.to_csv(os.path.join(censusDownloadDir, 'populationbyageandsex_CT_2021_acs5.csv'), index = False)

if not os.path.isfile(os.path.join(censusDownloadDir, 'hh_kids_nokids_CT_2021_acs5.csv')):
	...
	hhkids_CT.to_csv(os.path.join(censusDownloadDir, 'hh_kids_nokids_CT_2021_acs5.csv'), index = False)

if not os.path.isfile(os.path.join(censusDownloadDir, 'hhunit_CT_2021_acs5.csv')):
	...
	hhunit_CT.to_csv(os.path.join(censusDownloadDir, 'hhunit_CT_2021_acs5.csv'), index = False)
